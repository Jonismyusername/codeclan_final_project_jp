...
green_clean_names %>%
  ...
  labs(
    title = "Distance to green space for 65 years and older over time",
...
green_clean_names %>% 
  ...
  labs(
    title = "Distance to green space by ethnicity over time",
    subtitle = "Scotland average, 2013 - 2019",
    x = "\nYear",
    y = "Percentage of respondents\n"
  )+
...
community_clean_names %>%
  ...
  labs(
    title = "Changes in 'community belonging' over time for pensioners",
    subtitle = "Scotland average, 2013 - 2019",
    x = "\nYear",
    y = "Percentage of respondents\n"
  )+
...
neighbourhood_clean_names %>%
  ...
  labs(
    title = "How adults in Scotland rate their neighbourhood as a place to live,
by household type",
    subtitle = "Scotland average, 2019",
    x = "\nLevel of 'community belonging'",
    y = "Percentage of respondents\n",
